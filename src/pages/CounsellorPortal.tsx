...
import { Leaf, Heart, Headphones, UserCheck, Mail, Lock, Calendar, Clock, Users, AlertTriangle, CheckCircle, ArrowLeft, LogOut } from "lucide-react";
...
const CounsellorPortal = () => {
  ...
  const [sessions] = useState([
    { id: 1, studentId: "ST001", studentName: "John Doe", date: "2025-01-16", time: "10:00 AM", status: "pending", urgency: "high", concerns: "Anxiety and stress about exams" },
    { id: 2, studentId: "ST002", studentName: "Jane Smith", date: "2025-01-16", time: "2:00 PM", status: "pending", urgency: "moderate", concerns: "Feeling overwhelmed with coursework" },
    { id: 3, studentId: "ST003", studentName: "Mike Johnson", date: "2025-01-15", time: "11:00 AM", status: "completed", urgency: "low", concerns: "General wellbeing check" },
    { id: 4, studentId: "ST004", studentName: "Sarah Wilson", date: "2025-01-17", time: "3:00 PM", status: "pending", urgency: "critical", concerns: "Depression symptoms, urgent support needed" },
  ]);
